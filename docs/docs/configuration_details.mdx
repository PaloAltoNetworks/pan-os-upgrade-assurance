...
Following [`ConfigParser's`][cfgprs] [`dialect`][dialect], when no configuration is provided, **all** checks are triggered. *Notice* that in this situation checks that require configuration to run will return [`CheckStatus.SKIPPED`](/panos-upgrade-assurance/docs/api/utils#class-checkstatus).
...
The [`CheckFirewall.run_readiness_checks()`](/panos-upgrade-assurance/docs/api/check_firewall#checkfirewallrun_readiness_checks) take one more parameter: `report_style`. Format of the returned data depends on the value of this parameter. If the value is:
...
**Method:** [`CheckFirewall.check_arp_entry()`](/panos-upgrade-assurance/docs/api/check_firewall#checkfirewallcheck_arp_entry)
...
**Method:** [`CheckFirewall.check_pending_changes()`](/panos-upgrade-assurance/docs/api/check_firewall#checkfirewallcheck_pending_changes)
...
**Method:** [`CheckFirewall.check_content_version()`](/panos-upgrade-assurance/docs/api/check_firewall#checkfirewallcheck_content_version)
...
**Method:** [`CheckFirewall.check_free_disk_space()`](/panos-upgrade-assurance/docs/api/check_firewall#checkfirewallcheck_free_disk_space)
...
**Method:** [`CheckFirewall.check_expired_licenses()`](/panos-upgrade-assurance/docs/api/check_firewall#checkfirewallcheck_expired_licenses)
...
**Method:** [`CheckFirewall.check_ha_status()`](/panos-upgrade-assurance/docs/api/check_firewall#checkfirewallcheck_ha_status)
...
**Method:** [`CheckFirewall.check_ipsec_tunnel_status()`](/panos-upgrade-assurance/docs/api/check_firewall#checkfirewallcheck_ipsec_tunnel_status)
...
**Method:** [`CheckFirewall.check_ntp_synchronization()`](/panos-upgrade-assurance/docs/api/check_firewall#checkfirewallcheck_ntp_synchronization)
...
**Method:** [`CheckFirewall.check_panorama_connectivity()`](/panos-upgrade-assurance/docs/api/check_firewall#checkfirewallcheck_panorama_connectivity)

### `planes_clock_sync`

Checks difference between clocks for Management and Data planes.

**Method:** [`CheckFirewall.check_mp_dp_sync()`](/panos-upgrade-assurance/docs/api/check_firewall#checkfirewallcheck_mp_dp_sync)
...
**Method:** [`CheckFirewall.check_critical_session()`](/panos-upgrade-assurance/docs/api/check_firewall#checkfirewallcheck_critical_session)
...
**Method:** [`FirewallProxy.get_arp_table()`](/panos-upgrade-assurance/docs/api/firewall_proxy#firewallproxyget_arp_table)

### `content_version`

Grabs the currently installed Content DB version.

**Method:** [`CheckFirewall.get_content_db_version()`](/panos-upgrade-assurance/docs/api/check_firewall#checkfirewallget_content_db_version)

### `ip_sec_tunnels`

Takes a snapshot of configuration of all IPSec tunnels along with their state.

**Method:** [`CheckFirewall.get_ip_sec_tunnels()`](/panos-upgrade-assurance/docs/api/check_firewall#checkfirewallget_ip_sec_tunnels)

### `license`

Takes a snapshot of information about all licenses installed on a device.

**Method:** [`FirewallProxy.get_licenses()`](/panos-upgrade-assurance/docs/api/firewall_proxy#firewallproxyget_licenses)

### `nics`

Takes a snapshot of a state of all configured (not installed) network interfaces.

**Method:** [`FirewallProxy.get_nics()`](/panos-upgrade-assurance/docs/api/firewall_proxy#firewallproxyget_nics)

### `routes`

Takes a snapshot of the Route Table (this includes routes populated from DHCP as well as manually entered ones).

**Method:** [`FirewallProxy.get_routes()`](/panos-upgrade-assurance/docs/api/firewall_proxy#firewallproxyget_routes)

### `session_stats`

Gets information about the session statistics, such as current sessions count per a session type (TCP, UDP, etc).

**Method:** [`FirewallProxy.get_session_stats()`](/panos-upgrade-assurance/docs/api/firewall_proxy#firewallproxyget_session_stats)

## Reports

The reporting part is actually the result of comparison of two snapshots. It is advised to run reports using the common method as some of the comparison results are calculated with it. The common method is: [`SnapshotCompare.compare_snapshots()`](/panos-upgrade-assurance/docs/api/snapshot_compare#snapshotcomparecompare_snapshots).
...
For most reports, a generic comparison method is used ([`SnapshotCompare.get_diff_and_threshold()`](/panos-upgrade-assurance/docs/api/snapshot_compare#snapshotcompareget_diff_and_threshold)). It produces the standardized dictionary. For details, see documentation for this method. Common method assigns a report result to a report area providing a dictionary where keys are report areas and values are report results.
...
**Method:** [`SnapshotCompare.get_diff_and_threshold()`](/panos-upgrade-assurance/docs/api/snapshot_compare#snapshotcompareget_diff_and_threshold)
...
This report is slightly different than reports made with the [`SnapshotCompare.get_diff_and_threshold()`](/panos-upgrade-assurance/docs/api/snapshot_compare#snapshotcompareget_diff_and_threshold) method as the snapshot data is different (refer to the [`FirewallProxy.get_session_stats()`](/panos-upgrade-assurance/docs/api/firewall_proxy#firewallproxyget_session_stats) method documentation for details).
...
**Method:** [`SnapshotCompare.get_count_change_percentage()`](/panos-upgrade-assurance/docs/api/snapshot_compare#snapshotcompareget_count_change_percentage)
...
This report produces a `dict` as documented in the [`SnapshotCompare.get_count_change_percentage()`](/panos-upgrade-assurance/docs/api/snapshot_compare#snapshotcompareget_count_change_percentage) method documentation.
