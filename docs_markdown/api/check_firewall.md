...
- __node__ (`FirewallProxy`): Object representing a device against which checks and/or snapshots are run. See [`FirewallProxy`](./firewall_proxy.md#class-firewallproxy) class' documentation.
...
This method provides a convenient way of running snapshots of a device state. For details on configuration see [state snapshots](../configuration_details.md#state-snapshots) documentation.
