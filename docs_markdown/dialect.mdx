...
The [`ConfigParser`](./api/utils.md#class-configparser) class is used throughout the project. It assumes and understands a specific dialect, hence it's vital to know it understand it.
